...
export default function TopRatedMovies() {
  ...
  return (
    <>
      ...
      <div id="topRated" className="container mb-5 d-flex flex-column align-items-center justify-content-center">
        <h2 className="mb-0 h3 align-self-start">Top Rated Movies</h2>
            ...
            {nums.map((num: number, index: number): any => {
              return (
                <li key={index} className="page-item">
                  <button className="page-link shadow-none text-dark-blue" onClick={() => getItems("movie", "top_rated", setMovies, num)}>
                    {num}
                  </button>
                </li>
              );
