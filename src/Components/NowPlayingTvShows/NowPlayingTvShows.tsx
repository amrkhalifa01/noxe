...
export default function NowPlayingTvShows() {
  ...
  return (
    <>
      ...
      <div id="nowPlayingTvShows" className="container mb-5 d-flex flex-column align-items-center justify-content-center">
        <h2 className="mb-0 h3 align-self-start">Now Playing Shows</h2>
