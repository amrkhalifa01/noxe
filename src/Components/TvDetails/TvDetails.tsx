...
export default function TvDetails() {
  ...
  let { getDetails, goToDetails, isLoading, getItemsKeys, trailerKey } = useContext(movieApiDataContext);
  let tvShowId: any = searchParams.get("id");

  useEffect(() => {
    getDetails("tv", tvShowId, setTvShowDetails);
    getItemsKeys("tv", tvShowId);
  }, []);
          ...
          <div className="container-fluid px-0 min-vh-100 d-flex align-items-center justify-content-center py-5 over-layer">
            <div className="container pt-5">
              <div className="row g-4 d-flex align-items-center justify-content-center">
                                ...
                                return (
                                  <div key={index} className="col-lg-3">
                                    <div className="text-center">
                                      <LazyLoadImage
                                        effect="blur"
                                        placeholderSrc={Images.companyLogo}
                ...
                {trailerKey.key ? (
                  <>
                    <h2 className="h3 mt-5 mb-2 h3 text-center text-light fw-bold">Trailer:</h2>
                    <div className="col-lg-6">
                      <div>
                        <iframe className="rounded-3" width="100%" height="315" src={`https://www.youtube.com/embed/${trailerKey.key}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                      </div>
                    </div>
                  </>
                ) : (
